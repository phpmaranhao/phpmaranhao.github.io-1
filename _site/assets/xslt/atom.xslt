...
<xsl:template match="/atom:feed">
  ...
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://localhost:4000" class="icon-tree"> PHP Maranhão</a></h1>
    </li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000/" title="PHP Maranhão – 4Developer">
				<img src="http://localhost:4000/assets/img/apple-icon-72x72.png" alt="PHP Maranhão – 4Developer">
			</a>
